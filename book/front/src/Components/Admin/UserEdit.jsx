                        ...
                        <div className="col-4 col-8-large col-10-medium col-12-small">
                            <form>
                                <div className="row gtr-uniform">
                                    ...
                                    <div className="col-12">
                                        <Input onChange={handleForm} value={user.password} type="password" name="password" placeholder='Pakeisti Slaptazodi' autoComplete='new-password' />
                                    </div>
