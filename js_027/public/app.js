...
window.addEventListener('load', function (_) {
  ...
  writeButton.addEventListener('click', function (_) {
    ...
    axios.post('http://localhost/write', data).then(function (res) {
      console.log(res.data);
    })["catch"](function (error) {
      console.log(error);
    });
  });
  readButton.addEventListener('click', function (_) {
    axios.get('http://localhost/read').then(function (res) {
      var html = '';
      res.data.digits.forEach(function (d) {
        html += "<span>".concat(d, "</span>");
      });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjs_027"] = self["webpackChunkjs_027"] || [];
