...
window.addEventListener('load', function (_) {
  ...
  button.addEventListener('click', function (_) {
    ...
    input.value = '';
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('http://localhost/add-animal', {
      animal: animal
    }).then(function (res) {
  ...
  var getAllAnimals = function getAllAnimals() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('http://localhost/get-animals?sort=' + sort).then(function (res) {
      var html = '';
