  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <button type='button' className='red' onClick={_ => redClick('ka tu')}>Click!</button>
        <button type='button' className='yellow' onClick={e => buttonClick(e, 'valio')}>Click!</button>
        <button type='button' className='white' onClick={buttonClick}>Click!</button>
        <button type='button' className='green' onClick={_ => console.log('******')}>Click!</button>
        <ul>
            {
        ...
        <ul>
            ...
            :
            <li style={{color: 'lightgreen'}} key={i}>{f}</li>)
            }
        </ul>
      </header>
    </div>
