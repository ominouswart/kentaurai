...
function App() {
    ...
    const rem = <svg xmlns="http://www.w3.org/2000/svg" width="469.404px" height="469.404px" viewBox="0 0 469.404 469.404"><g><path d="M310.4,235.083L459.88,85.527c12.545-12.546,12.545-32.972,0-45.671L429.433,9.409c-12.547-12.546-32.971-12.546-45.67,0L234.282,158.967L85.642,10.327c-12.546-12.546-32.972-12.546-45.67,0L9.524,40.774c-12.546,12.546-12.546,32.972,0,45.671
                    ...
                    <div className="up-img">
                        {
                            image
                                ...
                                <>
                                    ...
                                    <label className='cb-svg remove' onClick={clearImage}>{rem}</label>
                                </>
                                :
                                null
                        }
