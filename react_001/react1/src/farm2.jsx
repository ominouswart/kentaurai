...
import './App.css';
import './Components/nd5/ganykla.scss';
import './buttons.scss';
    ...
    const getNumber = type => {
      ...
      const changeField = id => {
        setField(f => f.map(a => {
            ...
            return a.id === id ? {...a, field: (a.field ? 0 : 1)} : a
      ...
      <header className="App-header">
        <div className="fields">
            <div className="buttons">
                ...
                <button type='button' className='red' onClick={_ => setField([])}>Skerdykla!</button>
            </div>
            ...
            <div className="field">
            {
                    field.toSorted((a, b) => a.type.localeCompare(b.type)).map(a => a
                        .field === 1
                        ?
                        <div key={a.id} 
                        onClick={_ => changeField(a.id)}
